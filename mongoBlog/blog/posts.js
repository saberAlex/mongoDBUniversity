...
function PostsDAO(db) {
    ...
    this.getPostsByTag = function(tag, num, callback) {
        ...
        //for upgrade this performance you need to ensure that you have a compound index for the tags and date
    ...
    this.getPostByPermalink = function(permalink, callback) {
        "use strict";
        //for upgrading this performance you just need single index:
